class regression_loss {
  ...
  constructor(div) {
    ...
    this.color = d3.scaleLog().interpolate(function() { return d3.interpolatePiYG; });
    this.x = d3.scaleLinear().domain([-30, 30]).range([0, this.width]);
    this.y = d3.scaleLinear().domain([-30, 30]).range([this.height, 0]);
